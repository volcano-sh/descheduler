...
func SetDefaults_DefragmentationArgs(obj runtime.Object) {
	args, ok := obj.(*DefragmentationArgs)
	if !ok {
		klog.Errorf("obj with type %T could not parse", obj)
	}
	if args.ResourceType == "" {
		args.ResourceType = v1.ResourceCPU
	}
	if args.ProtectionThresholds == nil {
		args.ProtectionThresholds = nil
	}
	if args.FragmentThresholds == nil {
		args.FragmentThresholds = nil
	}
	if args.LowThresholds == nil {
		args.LowThresholds = nil
	}
